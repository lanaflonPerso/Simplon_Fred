      ...
      <div class="col-lg-6 col-md-8 col-sm-12">
        <form class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <input type="text" class="form-control" id="cpl" placeholder="Votre code postal">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-lg-4 hidden-xs hidden-sm" for="vil">Ville</label>
            <div class="col-lg-8">
              <input type="text" class="form-control" id="vil" placeholder="Votre ville">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-lg-4 hidden-xs hidden-sm" for="des">Description</label>
            <div class="col-lg-8">
              <textarea class="form-control" rows="5" id="des" placeholder="Votre description"></textarea>
            </div>
          </div>
