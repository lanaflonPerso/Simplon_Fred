...
public class JourNonTravaille {
	...
	public String[] getStringListeStringJoursFeries() {
		...
		this.stringListeStringJoursFeries[1]="p�ques";
		this.stringListeStringJoursFeries[2]="lundi de p�ques";
		this.stringListeStringJoursFeries[3]="f�te du travail";
		this.stringListeStringJoursFeries[4]="armistice du 8 mai 1945";
		this.stringListeStringJoursFeries[5]="ascension";
		this.stringListeStringJoursFeries[6]="pentec�te";
		this.stringListeStringJoursFeries[7]="lundi de penc�te";
		this.stringListeStringJoursFeries[8]="f�te nationale";
		...
		this.stringListeStringJoursFeries[12]="no�l";
