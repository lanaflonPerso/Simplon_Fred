...
public class Ecole2 {
	...
	public static void main(String[] args) {
	    ...
	    String url = "jdbc:mysql://localhost:3306/Ecole2";
	    String user = "root";
	...
	//    sql = "SELECT * FROM professeur"; // Exo 2
	    ...
	    sql+= " matiere inner join mat_prof on mat_id = mp_prof_k inner join";
	    sql+= " professeur on mp_prof_k = prof_id order by prof_nom";
